...
class Repository(CommandSystem):
    ...
    class get_item(Command):
        ...
        def execute(self):
            if self.uid != '':
                if self.uid not in self.outer_instance._items.keys():
                    return None
    ...
    class add_item(Command):
        ...
        def execute(self):
            ...
            if self.uid in self.outer_instance._items.keys():
    ...
    class remove_items(Command):
        ...
        def undo(self):
            for i, item in self.removed_items:
    ...
    class replace_item(Command):
        ...
        def execute(self):
            ...
            for i, item in self.outer_instance._items:
                if self.condition(item):
