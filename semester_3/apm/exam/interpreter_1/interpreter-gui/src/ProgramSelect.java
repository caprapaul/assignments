...
public class ProgramSelect {
    ...
    private ObservableList<Controller> getPrograms() {
        ...
        this.programs.add(this::exampleOne);
        this.programs.add(this::exampleTwo);
        this.programs.add(this::exampleThree);
        this.programs.add(this::exampleFour);
        this.programs.add(this::exampleFive);
        this.programs.add(this::exampleSix);
        this.programs.add(this::exampleSeven);
        this.programs.add(this::exampleEight);
        this.programs.add(this::exampleNine);
        this.programs.add(this::exampleTen);
        this.programs.add(this::exampleEleven);
        this.programs.add(this::exampleE1);
    ...
    private Controller exampleOne() {
        ...
        ProgramState program = new ProgramState(execution, symbols, output, files, heap, statement);
    ...
    private Controller exampleE1() {
        ...
        IRepository repository = new Repository("loge1.txt");
        repository.addState(program);
