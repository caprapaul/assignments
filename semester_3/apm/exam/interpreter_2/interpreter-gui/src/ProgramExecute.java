...
public class ProgramExecute {
    ...
    @FXML
    private TableView<LatchesRow> latches;
    @FXML
    private TableColumn<LatchesRow, Integer> latchesAddress;
    @FXML
    private TableColumn<LatchesRow, Integer> latchesValue;
    @FXML
    ...
    private void initialize() {
        ...
        this.latchesAddress.setCellValueFactory(new PropertyValueFactory<>("address"));
        this.latchesValue.setCellValueFactory(new PropertyValueFactory<>("value"));
    ...
    private void refresh() {
        ...
        //this.populateLatches(states.get(0));
    ...
    private void populateLatches(ProgramState state) {
        List<LatchesRow> rows = state.getLatches()
                                  .getAll()
                                  .stream()
                                  .map(entry -> new LatchesRow(entry.getKey(), entry.getValue()))
                                  .collect(Collectors.toList());

        this.latches.setItems(FXCollections.observableArrayList(rows));
    }
